...
class _NewsApiService implements NewsApiService {
  ...
  Future<Response<List<ArticleModel>>> getNewsArticle({
    ...
    final _options = _setStreamType<Response<List<ArticleModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late Response<List<ArticleModel>> _value;
    try {
      final articles = (_result.data!['articles'] as List<dynamic>)
          .map((e) => ArticleModel.fromJson(e as Map<String, dynamic>))
          .toList();
      _value = Response<List<ArticleModel>>(
        data: articles,
